...
typedef struct {
  real_T RAd;                          /* '<Root>/Gain' */
  real_T AngularVelocityrads;          /* '<Root>/Derivative1' */
  real_T AngularPositionRadians;       /* '<Root>/Gain1' */
  real_T y;                            /* '<Root>/WrapAround' */
...
typedef struct {
  ...
  real_T offset;                       /* '<Root>/WrapAround1' */
  real_T prev;                         /* '<Root>/WrapAround' */
  real_T acc;                          /* '<Root>/WrapAround' */
  boolean_T doneDoubleBufferReInit;    /* '<Root>/WrapAround1' */
  boolean_T doneDoubleBufferReInit_i;  /* '<Root>/WrapAround' */
 ...
 * '<S1>'   : 'Encoder_reader_simulink/Digital Port Read2'
 * '<S2>'   : 'Encoder_reader_simulink/WrapAround'
 * '<S3>'   : 'Encoder_reader_simulink/WrapAround1'
 * '<S4>'   : 'Encoder_reader_simulink/Digital Port Read2/ECSoC'
 * '<S5>'   : 'Encoder_reader_simulink/Digital Port Read2/ECSoC/ECSimCodegen'
 */
